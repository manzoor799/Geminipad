...
export const IconWrapper = ({ className = 'w-6 h-6', children }: { className?: string, children: React.ReactNode }) => (
...
export const SparklesIcon = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M4 21L5.5 18.5" />
    <path d="M18.5 5.5L20 4" />
...
export const StarIcon = ({ className = 'w-5 h-5', isFilled = false }) => (
